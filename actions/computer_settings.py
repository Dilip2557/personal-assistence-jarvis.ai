...
def computer_settings(
    ...
    if not _PYAUTOGUI:
        return (
            "pyautogui is not available. Ensure you are in a GUI session with DISPLAY set "
            "and X authorization, or avoid desktop action requests. "
