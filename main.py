...
# Auto-activate local .venv if running with system python
...
def _load_system_prompt() -> str:
    try:
        ...
        return (
            ...
            "Accept and process commands ONLY in English. If the user speaks or inputs text in any language other than English, ignore it completely, do not execute any tool, and do not respond."
        )
...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "The user will say this in English."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {},
